<aside class="main-sidebar">
    <header class="main-header clearfix">
        <a class="logo" href="{{ route('admin.dashboard.index') }}">
            @if (is_null($logo))
                <img src="{{ asset('build/assets/sidebar-logo.svg') }}" alt="sidebar logo">
            @else
        ...
        <a class="sidebar-logo-mini" href="{{ route('admin.dashboard.index') }}">
            @if (is_null($smallLogo))
                <img src="{{ asset('build/assets/sidebar-logo-mini.svg') }}" alt="sidebar logo">
            @else
                <img src="{{ $smallLogo }}" alt="sidebar logo">
            @endif
        </a>
